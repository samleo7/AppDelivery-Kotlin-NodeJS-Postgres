package com.example.delivery.activities.client.map
...
class ClientAddressMapActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun goToCreateAddress(){
        ...
        finish() // Se finaliza la actividad para regresar a ClientAddressCreateActivity
    }
    ...
    private fun onCameraMove(){
        ...
        googleMap?.setOnCameraIdleListener() {
            ...
            try {
                ...
                city = addressList[0].locality // Obtenemos la Ciudad
                country = addressList[0].countryName // Obtenemos el Pais
                address = addressList[0].getAddressLine(0) //Obtenemos la direccion
