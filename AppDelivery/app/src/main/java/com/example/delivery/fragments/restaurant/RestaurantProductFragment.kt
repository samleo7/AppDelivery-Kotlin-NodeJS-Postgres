...
class RestaurantProductFragment : Fragment() {
    ...
    private fun createProduct() {
        //Capturando los valores de los campos de textos
    ...
    private fun isValidForm(name:String, description:String, price:String): Boolean{
        ...
        if (imageFile1 == null){
            Toast.makeText(requireContext(), "Selecciona la image 1", Toast.LENGTH_SHORT).show()
            return false
        }
        if (imageFile2 == null){
            Toast.makeText(requireContext(), "Selecciona la image 2", Toast.LENGTH_SHORT).show()
            return false
        }
        if (imageFile3 == null){
            Toast.makeText(requireContext(), "Selecciona la image 3", Toast.LENGTH_SHORT).show()
            return false
        }
