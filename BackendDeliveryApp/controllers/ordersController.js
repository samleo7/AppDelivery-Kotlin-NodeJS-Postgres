...
module.exports = {
    ...
    async findByClienAndtStatus (req, res, next) {
        try{
            const status = req.params.status;
    ...
    async findByDeliveryAndtStatus (req, res, next) {
        try{
            const status = req.params.status;
    ...
    async updateToDispatched(req, res, next) {
        try{
            ...
            const user = await User.geNotificationsTokenById(order.id_delivery);
    ...
    async updateToOnTheWay(req, res, next) {
        try{
            ...
            const user = await User.geNotificationsTokenById(order.id_client);
